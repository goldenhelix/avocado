...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataConcept.field_name'
        db.add_column(u'avocado_dataconcept', 'field_name',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataConcept.field_name'
        db.delete_column(u'avocado_dataconcept', 'field_name')
    ...
    models = {
        ...
        u'avocado.datacontext': {
            ...
            'accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 5, 0, 0)'}),
