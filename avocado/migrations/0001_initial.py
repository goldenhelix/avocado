...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'avocado_revision', (
            ...
            ('changes', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
        ))
        db.send_create_signal('avocado', ['Revision'])

        # Adding model 'DataCategory'
        db.create_table(u'avocado_datacategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'avocado', ['DataCategory'])

        # Adding model 'DataField'
        db.create_table(u'avocado_datafield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('keywords', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('label_field_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('search_field_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('order_field_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('code_field_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ...
            ('indexable', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ...
            ('data_version', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fields+', null=True, to=orm['auth.Group'])),
            ('model_version_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('order', self.gf('django.db.models.fields.FloatField')(null=True, db_column='_order', blank=True)),
            ('internal', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('allowed_values', self.gf('ceviche.models.custom_fields.TextArrayField')(null=True, blank=True)),
            ('is_html', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'avocado', ['DataField'])

        # Adding unique constraint on 'DataField', fields ['app_name', 'model_name', 'field_name']
        db.create_unique(u'avocado_datafield', ['app_name', 'model_name', 'field_name'])

        # Adding M2M table for field sites on 'DataField'
        m2m_table_name = db.shorten_name(u'avocado_datafield_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('datafield', models.ForeignKey(orm[u'avocado.datafield'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['datafield_id', 'site_id'])

        # Adding model 'DataConcept'
        db.create_table(u'avocado_dataconcept', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('keywords', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('published', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('archived', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ident', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('internal', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['avocado.DataCategory'], null=True, blank=True)),
            ...
            ('use_in_annotations', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('avocado', ['DataConcept'])

        # Adding M2M table for field sites on 'DataConcept'
        m2m_table_name = db.shorten_name(u'avocado_dataconcept_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dataconcept', models.ForeignKey(orm['avocado.dataconcept'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['dataconcept_id', 'site_id'])

        # Adding model 'DataConceptField'
        db.create_table(u'avocado_dataconceptfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'avocado', ['DataConceptField'])

        # Adding model 'DataContext'
        db.create_table(u'avocado_datacontext', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('keywords', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('tree', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forks', null=True, to=orm['avocado.DataContext'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='datacontext+', null=True, to=orm['auth.User'])),
            ('session_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ('model_version_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('accessed', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 4, 0, 0))),
        ))
        db.send_create_signal(u'avocado', ['DataContext'])

        # Adding model 'DataView'
        db.create_table(u'avocado_dataview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('keywords', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('template', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('default', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forks', null=True, to=orm['avocado.DataView'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dataview+', null=True, to=orm['auth.User'])),
            ('session_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ('model_version_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('accessed', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 4, 0, 0))),
        ))
        db.send_create_signal(u'avocado', ['DataView'])

        # Adding model 'DataQuery'
        db.create_table(u'avocado_dataquery', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('keywords', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('distinct_count', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('record_count', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('tree', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('session', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('template', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('default', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forks', null=True, to=orm['avocado.DataQuery'])),
        ...
        db.send_create_signal(u'avocado', ['DataQuery'])

        # Adding M2M table for field shared_users on 'DataQuery'
        m2m_table_name = db.shorten_name(u'avocado_dataquery_shared_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dataquery', models.ForeignKey(orm[u'avocado.dataquery'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'avocado_datafield', ['app_name', 'model_name', 'field_name'])

        # Deleting model 'Revision'
        db.delete_table(u'avocado_revision')

        # Deleting model 'DataCategory'
        db.delete_table(u'avocado_datacategory')

        # Deleting model 'DataField'
        db.delete_table(u'avocado_datafield')

        # Removing M2M table for field sites on 'DataField'
        db.delete_table(db.shorten_name(u'avocado_datafield_sites'))

        # Deleting model 'DataConcept'
        db.delete_table(u'avocado_dataconcept')

        # Removing M2M table for field sites on 'DataConcept'
        db.delete_table(db.shorten_name(u'avocado_dataconcept_sites'))

        # Deleting model 'DataConceptField'
        db.delete_table(u'avocado_dataconceptfield')

        # Deleting model 'DataContext'
        db.delete_table(u'avocado_datacontext')

        # Deleting model 'DataView'
        db.delete_table(u'avocado_dataview')

        # Deleting model 'DataQuery'
        db.delete_table(u'avocado_dataquery')

        # Removing M2M table for field shared_users on 'DataQuery'
        db.delete_table(db.shorten_name(u'avocado_dataquery_shared_users'))
    ...
    models = {
        ...
        u'avocado.datacontext': {
            ...
            'accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 4, 0, 0)'}),
