...
SIMPLE_TYPES = {
    ...
    'genomic': 'genomic',
    'gene': 'gene',
    'sample integer': 'samplenumber',
    'sample float': 'samplenumber',
    'sample integer array': 'samplenumber',
    'sample float array': 'samplenumber'
}
...
OPERATORS = {
    ...
    'number': ('exact', '-exact', 'in', '-in', 'lt', 'lte', 'gt', 'gte',
               'range', '-range', 'isnull'),
    'samplenumber': ('exact', '-exact', 'in', '-in', 'lt', 'lte', 'gt', 'gte',
               'range', '-range', 'isnull'),
    'genomic': ('exact', '-exact', 'in', '-in', 'lt', 'lte', 'gt', 'gte',
               'range', '-range', 'isnull'),
    'gene': ('exact', '-exact', 'in', '-in', 'lt', 'lte', 'gt', 'gte',
               'range', '-range', 'isnull'),
    'sample': ('exact', '-exact', 'iexact', '-iexact', 'in', '-in',
