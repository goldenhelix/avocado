...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataConcept.model_version_id'
        db.add_column(u'avocado_dataconcept', 'model_version_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataConcept.model_version_id'
        db.delete_column(u'avocado_dataconcept', 'model_version_id')
    ...
    models = {
        ...
        u'avocado.datacontext': {
            ...
            'accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 23, 0, 0)'}),
